...
public class DepositMoneyUiTests extends BaseUiTest {
    ...
    public void depositMoneyUiTest() {
        ...
        new UserDashboardPage()
                ...
                .checkAlertMessageAndAccept(BankAlert.SUCCESSFULLY_DEPOSITED_TO_ACCOUNT.getMessage(account.getAccountNumber(), amount));
    ...
    public void depositedAmountVisibleUiTest() {
        ...
        softly.assertThat(new UserDashboardPage()
                .open()
                .clickToDepositMoneyButton()
                .getAccountBalance(String.valueOf(account.getId())).getText())
