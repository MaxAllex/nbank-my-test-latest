...
public class ChangeUserProfileUiTests extends BaseUiTest {
    ...
    public void changeUsernameTest() {
        ...
        softly.assertThat(userDashboardPage.getWelcomeText().shouldHave(Condition.text(newName)).getText()).contains(newName);
        softly.assertThat(userDashboardPage.getEditProfileSpan().shouldHave(Condition.text(newName)).getText()).contains(newName);
